...
<div class="wrapper">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled ">
                <li class="active">
                    <a href="/dashboard.php" data-toggle="collapse">Home</a>
                </li>
            </ul>

            <ul class="list-unstyled">
                <li class="active">
                    <a href="/dashboard.php?info=ready" data-toggle="collapse">View progress</a>
                </li>
            </ul>

            <ul class="list-unstyled" >
                <li  class="active">
                    <a href="index.php"  data-toggle="collapse">Edit entries</a>
                </li>
            </ul>
        </nav>
